...
# Mount static files for uploads under /api path so it routes through backend
    ...
    about_content = [
        {
            ...
            "section_key": "title",
            "content": {
                "en": "About Shivdhara Charitable",
                "gu": "શિવધારા ચેરીટેબલ વિશે"
            }
        },
        {
            "page_key": "about",
    ...
    stories = [
        {
            ...
            "help_provided": {"en": "Shivdhara Charitable sponsored Ramesh's complete education including school fees, books, uniform, and transportation for three years.", "gu": "શિવધારા ચેરીટેબલે રમેશના શાળા ફી, પુસ્તકો, ગણવેશ અને ત્રણ વર્ષ માટે પરિવહન સહિત સંપૂર્ણ શિક્ષણને સ્પોન્સર કર્યું."},
